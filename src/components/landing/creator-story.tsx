        ...
        >
          ...
          >
            <div className="relative aspect-square w-64 md:w-96 rounded-2xl overflow-hidden bg-white border border-gray-200 shadow-md transform transition-all duration-300 hover:-translate-y-2">
              <Image
                src="/johnnie.webp"
                alt="Johnnie, creator of ApplicaAI"
                fill
          ...
          >
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl text-violet-800">
                Why I Built ApplicaAI
              </h2>
              
              <div className="space-y-4 text-lg text-slate-800 leading-relaxed">
                <p>
                  Hi, I&apos;m Johnnie! I&apos;m a Computer Engineering student at Queen&apos;s University in Kingston, 
                  and like many students, I&apos;ve been through the challenging journey of searching for tech & engineering internships.
                </p>
                
                <p>
                  ApplicaAI is my project - a resume builder designed to help students and developers 
                  create ATS-optimized resumes without the hefty subscription costs of common ATS resume SaaS services. Because everyone deserves access to great tools.
                </p>
