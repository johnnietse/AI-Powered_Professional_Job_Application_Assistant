      ...
      >
        <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-lg border border-white/40 shadow-xl">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join 50,000+ professionals who are getting more interviews with ApplicaAI
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="https://github.com/johnnietse/AI-Powered_Professional_Job_Application_Assistant.git" 
              target="_blank"
